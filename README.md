...
My name is Maceo Bramante, and I am a graduate from Southern New Hampshire University after attending it's Computer Science program for three years after transferring credit from Great Bay Community College. 

During my time in the program, I have gained experience in several programming languages including C++, R, Python, C, Java, and JavaScript. Three of the most important concepts and skills I have learned are: 

The Software Development Life Cycle (SDLC) and Agile methodologies, including Scrum, sprint cycles, and feature-based backlog management. 

Object-Oriented Programming (OOP) principles such as abstraction, encapsulation, inheritance, and polymorphism, primarily learned through C++ and later applied in other languages such as JavaScript. 

Artificial Intelligence and Machine Learning, including developing algorithms, understanding large language models (LLMs), and creating machine learning-based applications. 
...
### CS 499 Final Project: Enhancing Previous Artifacts from CS-465 and CS-321

My goal for this course was to fully build my portfolio that includes previous artifacts from courses. 

These artifacts go under code reviews done by myself, where I record videos of my older code, evaluate if they follow styling, structural, semantical, and functional programming standards given by a SNHU issued document. 
At the end of the recorded video, I discuss my next step to enhance the code, addressing the vurnerabilities, while adding new functions that introduce topics that I've learned into my old code. These topics are Software Development and Design, Data Structures and Algorithms, and Data Storage. I decided to enhance two artifacts. One for the Software Design and Database Categories, and another for the Data Structure category. These enhancements are found in the root directory of the portfolio's repository. The old code they were based off of is committed in the repository as well, in their respective zip folders.

Here is the link to my code review regarding the two artifacts:

https://www.youtube.com/watch?v=IadAzFW36ak
